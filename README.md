...
Same goes for VPS Instances. \
These things are directly connected to the Internet and can turn into botnets pretty quickly. 

**So if you are not 100% sure how to harden and keep the system patched, please don't run it on a VPS. \
Find yourself an old Laptop or buy a RPI4 instead.**
